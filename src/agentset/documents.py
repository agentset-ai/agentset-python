...
class Documents(BaseSDK):
    ...
    def get_chunks_download_url(
        ...
        *,
        ...
        request = models.GetChunksDownloadURLRequest(
            document_id=document_id,
        )
        ...
        req = self._build_request(
            ...
            accept_header_value="application/json",
            http_headers=http_headers,
            _globals=models.GetChunksDownloadURLGlobals(
                namespace_id=self.sdk_configuration.globals.namespace_id,
            ),
            security=self.sdk_configuration.security,
            allow_empty_value=None,
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                config=self.sdk_configuration,
                base_url=base_url or "",
                operation_id="getChunksDownloadUrl",
                oauth2_scopes=None,
                security_source=get_security_from_env(
                    self.sdk_configuration.security, models.Security
                ),
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(
                models.GetChunksDownloadURLResponse, http_res
            )
        if utils.match_response(http_res, "400", "application/json"):
            response_data = unmarshal_json_response(
                errors.BadRequestErrorData, http_res
    ...
    async def get_chunks_download_url_async(
        self,
        *,
        document_id: str,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
    ...
    def get_file_download_url(
        ...
        *,
        ...
        request = models.GetFileDownloadURLRequest(
            document_id=document_id,
        )
        ...
        req = self._build_request(
            ...
            accept_header_value="application/json",
            http_headers=http_headers,
            _globals=models.GetFileDownloadURLGlobals(
                namespace_id=self.sdk_configuration.globals.namespace_id,
            ),
            security=self.sdk_configuration.security,
            allow_empty_value=None,
        ...
        response_data: Any = None
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(models.GetFileDownloadURLResponse, http_res)
        if utils.match_response(http_res, "400", "application/json"):
            response_data = unmarshal_json_response(
                errors.BadRequestErrorData, http_res
            )
