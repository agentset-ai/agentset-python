...
try:
    DocumentWebhookEventSourceYoutubeVideo.model_rebuild()
except NameError:
    pass
try:
    DocumentWebhookEventSourceCrawledPage.model_rebuild()
except NameError:
    pass
try:
    DocumentWebhookEventSourceManagedFile.model_rebuild()
except NameError:
    pass
try:
    DocumentWebhookEventSourceFile.model_rebuild()
except NameError:
    pass
try:
    DocumentWebhookEventSourceText.model_rebuild()
except NameError:
    pass
try:
    DocumentWebhookEventData.model_rebuild()
except NameError:
    pass
try:
    DocumentWebhookEvent.model_rebuild()
except NameError:
    pass
